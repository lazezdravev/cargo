        ...
        <div class="col-12 mb-3 mb-lg-5">
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <div class="col-md-12">
                        <img src="/assets/img/testimonials/medium/{{ $testimonial->image }}" alt="testimonial" />
                    </div>
                    <form class="row g-3" method="post" action="{{ route('testimonials.update', $testimonial->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" value="{{ $testimonial->title }}">
                            @error('title')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-12 col-md-12 mb-5">
                            ...
                            <textarea name="description" id="description" placeholder="Textarea"
                                      class="form-control ckeditor">{{ $testimonial->description }}</textarea>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <a href="/admin/testimonials" class="btn btn-secondary mb-2 me-2">
                                                <span class="material-symbols-rounded align-middle me-2">
                                                    arrow_back_ios
                                                    </span> Back</a>
                        </div>
