        ...
        <div class="col-12">
            <div class="card table-card table-nowrap mb-3 mb-lg-5">
                <div class="card-header">
                    <a href="/admin/testimonials/create" class="btn btn-primary mb-2 me-2">
                    ...
                    <table class="table align-middle table-hover mb-0">
                        ...
                        @foreach($testimonials as $testimonial)
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0 me-3">
                                            <img src="/assets/img/testimonials/thumbnails/{{ $testimonial->image }}" class="avatar sm rounded-circle"
                                                 alt="">
                                        </div>
                                ...
                                <td>
                                    <div class="flex-grow-1">
                                        <h6 class="mb-0">{!!  Str::limit(strip_tags($testimonial->description), 20, '...') !!}</h6>
                                ...
                                <td>
                                    <div class="d-flex justify-content-end align-items-center">
                                        <a href="/admin/testimonials/{{ $testimonial->id }}" data-tippy-content="View">
                                        <span
                                        ...
                                        <a href="/admin/testimonials/{{ $testimonial->id }}/edit" data-tippy-content="Edit">
                                            <span
                                                class="material-symbols-rounded align-middle fs-5 text-body">edit</span>
                                        </a>
                                        <!--Divider line-->
                                        <span class="border-start mx-2 d-block height-20"></span>
                                        <form action="{{ route('testimonials.destroy', $testimonial->id )}}" method="post" class="areyousure">
                                            @csrf
                                            @method('delete')
