...
@section('content')
    <div class="container">
        <div class="row">
            ...
            @endif
            <div class="col-12">
                <h1 style="text-align: center">Save image to service: {{ $category->name }}</h1>
                <hr>
                <form action="{{ route('gallery.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12 mb-4">
                        <label for="inputImage" data-tippy-placement="bottom"
                               data-tippy-content="Upload images" class="btn btn-primary me-3">
                            Upload images
                        </label>
                        <input type="file"
                    ...
                    <div class="col-12 col-md-12 mb-4">
                        ...
                        <a href="/admin/gallery" class="btn btn-secondary mb-2 me-2">
                                                <span class="material-symbols-rounded align-middle me-2">
                                                    arrow_back_ios
                                                    </span> Back</a>
                    </div>
