        ...
        <div class="col-12">
            <div class="card table-card table-nowrap mb-3 mb-lg-5">
                <div class="card-header">
                    <a href="/admin/blogs/create" class="btn btn-primary mb-2 me-2">
                    ...
                    <table class="table align-middle table-hover mb-0">
                        ...
                        @foreach($blogs as $blog)
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0 me-3">
                                            <img src="/assets/img/blogs/thumbnails/{{ $blog->image }}" class="avatar sm rounded-circle"
                                                 alt="">
                                        </div>
                                ...
                                <td>
                                    <div class="flex-grow-1">
                                        <h6 class="mb-0">{!!  Str::limit(strip_tags($blog->description), 20, '...') !!}</h6>
                                ...
                                <td>
                                    <div class="d-flex justify-content-end align-items-center">
                                        <a href="/admin/blogs/{{ $blog->id }}" data-tippy-content="View">
                                        <span
                                        ...
                                        <a href="/admin/blogs/{{ $blog->id }}/edit" data-tippy-content="Edit">
                                            <span
                                                class="material-symbols-rounded align-middle fs-5 text-body">edit</span>
                                        </a>
                                        <!--Divider line-->
                                        <span class="border-start mx-2 d-block height-20"></span>
                                        <form action="{{ route('blogs.destroy', $blog->id )}}" method="post" class="areyousure">
                                            @csrf
                                            @method('delete')
