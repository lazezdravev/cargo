    ...
    <div class="row">
        <div class="col-12 mb-3 mb-lg-5">
            <div class="card h-100">
                ...
                <div class="card-body">
                    <form class="row g-3" method="post" action="{{ route('jobs.store') }}" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="form-check me-3">
                                        <input type="radio" checked="" name="option" id="sActive" class="form-check-input" value="team">
                                        <label for="sActive">Team</label>
                                    </div>
                                    <div class="form-check me-3">
                                        <input type="radio" name="option" id="sDeactive" class="form-check-input" value="solo">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('equipment') is-invalid @enderror" id="equipment" name="equipment">
                            @error('equipment')
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" id="mapsearch" class="form-control @error('place') is-invalid @enderror" name="place">
                            @error('place')
