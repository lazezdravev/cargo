        ...
        <div class="col-12 mb-3 mb-lg-5">
            <div class="card h-100">
                <div class="card-header">
                    <h5 class="mb-1">Обнови Slider</h5>
                ...
                <div class="card-body">
                    ...
                    <div class="col-md-12">
                        <img src="/assets/img/slider/medium/{{ $slider->image }}" alt="Slider" />
                    </div>
                    <form class="row g-3" method="post" action="{{ route('slider.update', $slider->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="col-12 col-md-12 mb-5">
                            ...
                            <textarea name="description" id="description" placeholder="Textarea"
                                      class="form-control ckeditor">{{ $slider->description }}</textarea>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <a href="/admin/slider" class="btn btn-secondary mb-2 me-2">
                                                <span class="material-symbols-rounded align-middle me-2">
                                                    arrow_back_ios
                                                    </span> Back</a>
                        </div>
