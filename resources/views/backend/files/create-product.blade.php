...
@section('content')
    <div class="container">
        <div class="row">
            ...
            @endif
            <div class="col-12">
                <h1 style="text-align: center">Add file to: {{ $product->title }}</h1>
                <hr>
                <form action="{{ route('file-product.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="col-md-12 mb-4">
                        <label for="inputImage" data-tippy-placement="bottom"
                               data-tippy-content="Upload file" class="btn btn-primary me-3">
                            Upload file
                        </label>
                        <input type="file"
                               class="form-control d-none w-0 h-0 position-absolute @error('image') is-invalid @enderror"
                               id="inputImage" name="file" multiple>
